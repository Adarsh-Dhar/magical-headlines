    ...
    "instructions": [
        ...
        },
        {
            ...
            "accounts": [
                ...
                {
                    "name": "marketSolAccount";
                    "docs": [
                        "Market SOL account (PDA for SOL storage)"
                    ];
                    "writable": true;
                    "pda": {
                        "seeds": [
        ...
        },
        {
            "name": "getMarketCap";
            "docs": [
                "Get the market cap in lamports (price * circulating_supply)"
            ];
            "discriminator": [
                74,
                93,
        ...
        {
            "name": "migrateClearStaking";
            "docs": [
                "One-time migration: return staked tokens and pay accumulated fees to author"
            ];
            "discriminator": [
                203,
                178,
